...
TEST_F(MyStringTester, countingWordsNumbersInText)
{
    ...
    const char weddingPlay[] = R"DELIMITER(Dawno, dawno temu zyli sobie krol z krolowa. Mieli konie, karete i woznice. Kiedys krol zawolal woznice i tak mu powiedzial: "Woznico zaprzegaj konie do karety, bo krolowa chce pojechac na spacer". Posluszny woznica poszedl i zapial konie do karety. Kiedy krol z krolowa wsiedli do karety, krol zawolal: "Woznico daj koniom znak do jazdy". I pojechali.
                               Para krolewska jedzie w swej pieknej karecie przez okolice, nagle prawy kon okulal, lewemu koniowi nic sie nie stalo. Przestraszony krol zawolal: "Woznico, woznico, moj drogi woznico, sprawdz, co sie stalo".
                               Krolowa ze strachu zemdlala, a woznica znalazl w kopycie prawego konia gwozdz i go wyciagnal. W kopycie lewego konia nie znalazl nic.
                               Po chwili zniecierpliwiony krol zwraca sie z pytaniem do woznicy: "Woznico, woznico, moj drogi woznico czy wszystko w porzadku?" Woznica odpowiada ,ze tak. Siada na kozle i daje koniom znak do jazdy.
                               Para krolewska w swej pieknej karecie, zlotej karecie jedzie dalej. Po chwili krol wychyla sie z okna karety i mowi do woznicy: "Woznico, woznico, moj drogi woznico, zatrzymaj konie, bo krolowa chce zaczerpnac swiezego powietrza". Woznica zatrzymuje konie i kareta staje. Z karety wysiada krol i krolowa. Nagle w oddali slychac grzmot - zaczyna padac deszcz, wszyscy sa mokrzy, nie ma co czekac - krol zarzadza powrot na zamek.
                               Po przybyciu na zamek konie zatrzymuja sie i krol i krolowa wysiadaja z karety. Krol wola do woznicy: "Woznico, moj drogi woznico wyprzegnij konie i odstaw karete". Zadowolona i szczesliwa krolowa pyta po chwili: "Woznico czy odstawiles konie i karete?" Woznica odpowiada, ze tak.)
...
{
    // source of quote: Izydor z Sewilii: https://pl.wikipedia.org/wiki/Izydor_z_Sewilli#Sentencje_z_dzie.C5.82_.C5.9Bw._Izydora
    const char quote[] = "Nauczania powinny sie odznaczac poprawnocia, prostota, otwartocia, "
                         "powaga i skromnocia, dalej: taktem i wdziekiem. "
                         "Do kazdego trzeba przemawiac indywidualnie, "
                         "w zaleznoci od jego stanu i poziomu moralnego. "
                         "A wiec kaznodzieja powinien wprzod przemylec, co ma mówic, "
...
{
    // source of quote: Izydor z Sewilii: https://pl.wikipedia.org/wiki/Izydor_z_Sewilli#Sentencje_z_dzie.C5.82_.C5.9Bw._Izydora
    const char quote[] = "Niesprawiedliwy to kto, kto zle uzywa swoich dobr, "
...
TEST_F(MyStringTester, joiningContainer)
{
    ...
    {
        "tarpan", "tur",  "drop zwyczajny", "jaszczurka zielona", "jesiotr zachodni", "karliczka zwyczajna", "norka europejska", "pustuleczka", "sep plowy", "strepet", "susel moregowany", "brodawnica", "mrowkolew drzewny", "pazurecznik wielki"
    };
    const MyString polishExtinctAnimalsAsString = "tarpan, tur, drop zwyczajny, jaszczurka zielona, jesiotr zachodni, karliczka zwyczajna, norka europejska, pustuleczka, sep plowy, strepet, susel moregowany, brodawnica, mrowkolew drzewny, pazurecznik wielki";
