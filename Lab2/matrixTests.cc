...
namespace
{
constexpr size_t elementsInEachDimensions = 2;
} // namespace
...
TEST_F(MatrixTester, constructionEmptyMatrix_expectedAllElementsAreZero)
{
    ...
    static_assert (m.getSize() == elementsInEachDimensions, "Expected elements in each dimentions is 2!");
...
{
    const MatrixElement sourceMatrix[elementsInEachDimensions][elementsInEachDimensions] =
    {
        { 1, 2 },
        { 3, 4 }
    };
...
TEST_F(MatrixTester, additionOfTwoMatrixes_expectedMatrixWithSumOfElementsReturned)
{
    ...
    const MatrixElement sourceMatrix2[elementsInEachDimensions][elementsInEachDimensions] =
    {
        { 5, 6 },
        { 7, 8 }
    };
...
TEST_F(MatrixTester, matrixConverseOperatorIntoSizeType_expected2ReturnElementsInEachDimentions)
{
    ...
    ASSERT_EQ(elementsInEachDimensions, valueFromConversion);
}
